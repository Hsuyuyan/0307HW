...
若使用Treemap,無法表示出小兒麻痺在美國各州各年度發生率變化 (各州為底、一年總計使用顏色表示、無法表示每年)， 因此我選擇使用Heapmap來表示， Heapmap能顯示有三個變數所呈現的圖形。
...
![](0516hw6_files/figure-markdown_github/unnamed-chunk-4-1.png)<!-- -->

### 解釋圖形

圖形中，x軸為年分，y軸為美國各州，中間呈現各州該年度的總發生率， 而顏色代表總發生率的數值高(紫色)到低(白色)， 可從圖形中看出， 在1955年後，因為有了小兒麻痺的疫苗， 各州的小兒麻痺人數漸漸減少。
